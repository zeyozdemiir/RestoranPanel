...
const initialOperations = [
  {
    ...
    progress: 72,
    riskLevel: "Orta",
    note: "Açık büfe düzeni, kahvaltı pizzası sunumu ve rezervasyon masaları kontrol edilecek.",
  },
  {
    id: 2,
    title: "Kritik stok ürünleri kontrolü",
    area: "Mutfak",
    shift: "Sabah",
    owner: "Mutfak",
    priority: "Yüksek",
  ...
  {
    id: 3,
    title: "Akşam rezervasyon masa planı",
    area: "Operasyon",
    shift: "Akşam",
    owner: "Yönetim",
    priority: "Orta",
    ...
    progress: 30,
    riskLevel: "Düşük",
    note: "Cam kenarı ve VIP müşteri talepleri CRM notlarıyla kontrol edilecek.",
  },
  {
    id: 4,
    ...
    progress: 100,
    riskLevel: "Düşük",
    note: "Basil Kiss, Kuzu Kulağı ve özel kokteyl reçeteleri hazır.",
  },
];
...
export default function OperationsCenter() {
  ...
  const criticalOperation = [...operations].sort((a, b) => {
    ...
    return (
      ...
      (priorityWeight[a.priority] + riskWeight[a.riskLevel])
    );
  })[0];
    ...
    <div className="space-y-8">
        ...
        <div className="mt-3 flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[#7d6b5a]">
              Günlük servis akışını, kritik görevleri, sorumlu ekipleri,
              öncelikleri ve riskli operasyon başlıklarını tek ekranda takip et.
            </p>
          </div>
      ...
      <div className="grid grid-cols-4 gap-5">
        <div className="rounded-3xl border border-[#e3d6c4] bg-white p-6 shadow-sm">
          <p className="text-sm text-[#8a7560]">Toplam İş Akışı</p>
      ...
      >
        <div className="mb-5">
          <h2 className="text-lg font-semibold text-[#211914]">
            Yeni Operasyon Başlığı Ekle
          </h2>

          <p className="mt-1 text-sm text-[#8a7560]">
            Günlük servis, mutfak, bar, pazarlama ve yönetim aksiyonlarını
            buradan kaydet.
          </p>
        </div>
      ...
      <div className="grid grid-cols-[1.3fr_0.7fr] gap-6">
        <div className="overflow-hidden rounded-3xl border border-[#e3d6c4] bg-white shadow-sm">
          <div className="border-b border-[#eadfce] px-6 py-5">
            ...
            <p className="mt-1 text-sm text-[#8a7560]">
              İlerleme, risk, öncelik ve durum bilgisi operasyon akışını
              netleştirir.
            </p>
          </div>
                ...
                >
                  <td className="px-6 py-4">
                    ...
                    <p className="mt-1 text-xs text-[#8a7560]">
                      Sorumlu: {operation.owner} / Saat: {operation.dueTime}
                    </p>
                  ...
                  <td className="px-6 py-4">
                    ...
                    <span
                      className={`mt-2 inline-flex rounded-full border px-3 py-1 text-xs font-medium ${getRiskClass(
                        operation.riskLevel
                      )}`}
                    >
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-[#e3d6c4] bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-[#8a7560]">
              Operasyon başlıklarının alan bazlı dağılımı.
            </p>
              ...
              {areas.map((area) => {
                ...
                const areaProgress =
                  areaOperations.length === 0
                    ? 0
                    : areaOperations.reduce(
                        (total, operation) =>
                          total + Number(operation.progress),
                        0
                      ) / areaOperations.length;
                  ...
                  <div key={area} className="rounded-2xl bg-[#fbf8f3] p-4">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="text-sm font-semibold text-[#211914]">
                        %{areaProgress.toFixed(1)}
                      </span>
                    </div>

                    <p className="mt-3 text-xs text-[#8a7560]">
                      Kayıt sayısı: {areaOperations.length}
                    </p>
                  </div>
                );
              })}
          ...
          <div className="rounded-3xl border border-[#e3d6c4] bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-[#7d6b5a]">
              Bu ekran ileride rezervasyon, masa, stok, ekip, görev listesi ve
              günlük çeklist modüllerinden gelen verilerle otomatik beslenecek.
            </p>
          </div>
        </div>
      </div>
