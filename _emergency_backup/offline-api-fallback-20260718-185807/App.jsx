...
// HANDSOFF_EMERGENCY_AUTH_USER
const HANDSOFF_EMERGENCY_USER = {
  id: "local-admin",
  name: "HandsOff Admin",
...
try {
  localStorage.setItem("handsoff_token", "local-dev-token");
  ...
  localStorage.setItem("handsoff_user", JSON.stringify(HANDSOFF_EMERGENCY_USER));
  localStorage.setItem("user", JSON.stringify(HANDSOFF_EMERGENCY_USER));
  localStorage.setItem("currentUser", JSON.stringify(HANDSOFF_EMERGENCY_USER));
  localStorage.setItem("authUser", JSON.stringify(HANDSOFF_EMERGENCY_USER));

  localStorage.setItem("handsoff_is_logged_in", "true");
  localStorage.setItem("isLoggedIn", "true");
  localStorage.setItem("handsoff_last_requested_page", "Yönetim Özeti");
} catch (error) {
  console.warn("Emergency auth yazilamadi", error);
}
// HANDSOFF_EMERGENCY_AUTH_USER_END
function isPermissionStatusPage(activePage) {
  const page = String(activePage || "").toLocaleLowerCase("tr-TR");

  return (
    page.includes("yetki durumu") ||
    page.includes("yetki Ã¶zeti") ||
...
function isActionPlanPage(activePage) {
  ...
  return (
    ...
    page.includes("gÃ¶rev takip") ||
    page.includes("gorev takip") ||
    page.includes("yÃ¶netim gÃ¶rev") ||
...
function isDailyChecklistPage(activePage) {
  ...
  return (
    page.includes("gÃ¼nlÃ¼k kontrol listesi") ||
...
function isReportCenterPage(activePage) {
  ...
  return (
    ...
    page.includes("yÃ¶netim raporlarÄ±") ||
...
function isMonthlyManagementReportPage(activePage) {
  ...
  return (
    page.includes("aylÄ±k") ||
    page.includes("aylik") ||
    page.includes("ay raporu") ||
    page.includes("aylÄ±k yÃ¶netim") ||
...
function isDailyClosingReportPage(activePage) {
  ...
  return (
    page.includes("gÃ¼n sonu") ||
    page.includes("gun sonu") ||
    page.includes("kapanÄ±ÅŸ") ||
...
function isBackupExportPage(activePage) {
  ...
  return (
    ...
    page.includes("dÄ±ÅŸa aktar") ||
    page.includes("disa aktar") ||
    page.includes("veri dÄ±ÅŸa") ||
...
function isDailySalesPage(activePage) {
  ...
  return (
    page.includes("ciro") ||
    page.includes("gelir giriÅŸi") ||
    page.includes("gelir girisi") ||
    page.includes("gÃ¼nlÃ¼k gelir") ||
    page.includes("gunluk gelir") ||
    page.includes("gÃ¼nlÃ¼k satÄ±ÅŸ") ||
...
function isSupplierStatementPage(activePage) {
  ...
  return (
    ...
    page.includes("borÃ§") ||
    page.includes("borc") ||
    page.includes("tedarikÃ§i Ã¶deme") ||
...
function isStockCountPage(activePage) {
  ...
  return (
    ...
    page.includes("stok sayÄ±m") ||
    page.includes("stok sayim") ||
    page.includes("sayÄ±m") ||
    page.includes("sayim") ||
...
function isPurchaseOrdersPage(activePage) {
  ...
  return (
    ...
    page.includes("stok faturasÄ±") ||
    page.includes("stok faturasi") ||
    page.includes("stok / satÄ±n") ||
...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      "KÄ±rÄ±lma & Zayi",
      "Åarap Envanteri",
      "Ä°Ã§ki & Bar Envanteri",
      "Åarap Pairing",
    ],
  },
  {
    title: "Ekip & MÃ¼ÅŸteri",
    items: [
      "Ekip Merkezi",
      "Personel & Vardiya",
      "Bordro",
...
const revenueBars = [
  ...
  { label: "Ã‡ar", value: "110K", height: "72%" },
    ...
    <div className="splash">
      ...
      <div className="splash-card fade-up">
        ...
        <div className="splash-steps">
          ...
          <div className="splash-step">
            <span>03</span>
            <strong>Panel hazÄ±rlanÄ±yor</strong>
          </div>
        </div>
      </div>
    </div>
...
function LoginScreen({ onLogin }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setError("Backend baÄŸlantÄ±sÄ± kurulamadÄ±. Backend Ã§alÄ±ÅŸÄ±yor mu kontrol et.");
    } finally {
          ...
          <div className="login-left">
            <div>
              ...
              <h1 className="login-title">
                Her restoran iÃ§in ayrÄ±, gÃ¼venli ve ÅŸÄ±k yÃ¶netim paneli.
              </h1>

              <p className="login-desc">
                HandsOff; restoranlarÄ±n kasa, rezervasyon, stok, ekip, menÃ¼,
                satÄ±ÅŸ ve rapor sÃ¼reÃ§lerini tek sistemde toplar. Her iÅŸletme
                sadece kendi hesabÄ±na ve kendi verilerine eriÅŸir.
              </p>
            </div>
            ...
            <div className="form-card">
              <div className="form-head">
                <div>
                  ...
                  <h2 className="form-title">Panele GiriÅŸ</h2>

                  <p className="form-desc">
                    Restoran hesabÄ±na giriÅŸ yaparak yÃ¶netim paneline eriÅŸ.
                  </p>
                </div>
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-actions">
        <input className="search-box" placeholder="ModÃ¼l, rapor veya iÅŸlem ara" />
...
function Dashboard({ user }) {
  const [dashboardData, setDashboardData] = useState(HANDSOFF_EMERGENCY_USER);
  ...
  useEffect(() => {
    async function fetchDashboard() {
      try {
        ...
        if (!token) {
          setDashboardError("Token bulunamadÄ±. Ã‡Ä±kÄ±ÅŸ yapÄ±p tekrar giriÅŸ yap.");
        ...
        if (!response.ok) {
          setDashboardError(data.message || "Dashboard verisi alÄ±namadÄ±.");
          setDashboardLoading(false);
          return;
        }
        ...
        setDashboardError("Backend baÄŸlantÄ±sÄ± kurulamadÄ±.");
      } finally {
        setDashboardLoading(false);
      }
    }
        ...
        <div className="hero">
          <div className="hero-content">
            <div>
              ...
              <h1>Dashboard yÃ¼kleniyor</h1>

              <p>Restoran verileri backend Ã¼zerinden hazÄ±rlanÄ±yor.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="hero">
          <div className="hero-content">
            <div>
              ...
              <h1>Dashboard verisi alÄ±namadÄ±</h1>
      ...
      <div className="hero">
        <div className="hero-content">
          <div>
            ...
            <p>
              GÃ¼nlÃ¼k satÄ±ÅŸ, kasa, rezervasyon, stok ve ekip akÄ±ÅŸÄ±nÄ± tek
              merkezden takip et. Bu ekrandaki veriler artÄ±k backend Ã¼zerinden
              restoran hesabÄ±na gÃ¶re geliyor.
            </p>
          </div>

          <button className="hero-button">GÃ¼nlÃ¼k Raporu AÃ§</button>
        </div>
      </div>
      ...
      <div className="panel-grid">
        <div className="panel">
          <div className="panel-head">
            <div>
              <h2>HaftalÄ±k gelir gÃ¶rÃ¼nÃ¼mÃ¼</h2>

              <p className="panel-sub">
                Backend Ã¼zerinden restoran bazlÄ± gelen haftalÄ±k Ã¶zet.
              </p>
            </div>
        ...
        <div className="panel">
          <div className="panel-head">
            <div>
              ...
              <p className="panel-sub">BugÃ¼n kontrol edilmesi gereken iÅŸler.</p>
            </div>

            <span className="mini-pill">CanlÄ±</span>
          </div>
    ...
    <div className="page">
      <div className="hero">
        <div className="hero-content">
          <div>
            ...
            <p>
              {title} modÃ¼lÃ¼ iÃ§in gÃ¼venli demo ekranÄ±. Bu alan gerÃ§ek formlar,
              tablolar, filtreler, raporlar ve backend baÄŸlantÄ±larÄ±yla
              geliÅŸtirilecek.
            </p>
          </div>

          <button className="hero-button">ModÃ¼l Raporu</button>
        </div>
      </div>

      <div className="cards">
        <StatCard title="Durum" value="HazÄ±r" note="Frontend demo ekran" />

        <StatCard title="Veri KaynaÄŸÄ±" value="Demo" note="Backend sonra" />

        <StatCard title="Yetki" value="Restoran BazlÄ±" note="SaaS yapÄ±" />

        <StatCard title="BaÄŸlantÄ±" value="PlanlandÄ±" note="API sonra" />
      </div>
      ...
      <div className="panel-grid">
        <div className="panel">
          <div className="panel-head">
            <div>
              <h2>{title} akÄ±ÅŸ Ã¶zeti</h2>

              <p className="panel-sub">
                ModÃ¼lÃ¼n Ã¼retim sÃ¼rÃ¼mÃ¼nde sahip olacaÄŸÄ± ana alanlar.
              </p>
            </div>
          ...
          <table className="module-table">
            ...
            <tbody>
              <tr>
                <td>Form</td>
                <td>PlanlandÄ±</td>
                <td>Veri giriÅŸi yapÄ±lacak</td>
              </tr>

              <tr>
                <td>Tablo</td>
                <td>PlanlandÄ±</td>
                <td>KayÄ±t listesi gÃ¶sterilecek</td>
              </tr>
              ...
              <tr>
                <td>Backend</td>
                <td>Sonra</td>
                <td>Restoran bazlÄ± API baÄŸlanacak</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="panel">
          <div className="panel-head">
            <div>
              ...
              <p className="panel-sub">Bu ekranÄ±n satÄ±ÅŸ/demo mantÄ±ÄŸÄ±.</p>
            </div>
          ...
          <div className="list">
            <ListItem
              title="GÃ¼venli demo ekranÄ±"
              description="Bu ekran dÄ±ÅŸ modÃ¼l import etmeden Ã§alÄ±ÅŸÄ±r."
              status="Aktif"
            />

            <ListItem
              title="Restoran ayrÄ±mÄ±"
              description="Backend tarafÄ±nda her veri restaurantId ile ayrÄ±lacak."
              status="PlanlÄ±"
            />

            <ListItem
              title="Sonraki adÄ±m"
              description="Bu demo ekrandan gerÃ§ek modÃ¼le tek tek geÃ§ilecek."
              status="Devam"
            />
          </div>
        </div>
...
function Panel({ user, onLogout }) {
  const [activePage, setActivePage] = useState("YÃ¶netim Ã–zeti");
...
return (
    <div className="app">
      <aside className="sidebar">
        ...
        <h2 className="sidebar-title">YÃ¶netim Paneli</h2>

        <p className="sidebar-desc">
          Operasyon, satÄ±ÅŸ, stok, ekip ve finans kontrol ekranÄ±.
        </p>
      ...
      <main className="main">
        ...
        {isExecutiveDashboardPage(activePage) ? (
          ...
          activePage === "Kar Zarar" || activePage === "KÃ¢r Zarar" ? (
          <ProfitLossPage user={user} />
        ) : (
          activePage === "TedarikÃ§iler" ||
        activePage === "TedarikÃ§i YÃ¶netimi" ||
        activePage === "Tedarikci YÃ¶netimi" ||
...
export default function App() {
  ...
  if (bootLoading) {
    screen = (
      <SplashScreen
        title="HandsOff aÃ§Ä±lÄ±yor"
        subtitle="Restoran yÃ¶netim paneli, gÃ¼venli oturum ve iÅŸletme alanÄ± hazÄ±rlanÄ±yor."
      />
    );
    ...
    screen = (
      <SplashScreen
        ...
        subtitle="Restoran hesabÄ± yÃ¼kleniyor ve operasyon ekranlarÄ± aÃ§Ä±lÄ±yor."
      />
    );
  } else if (!session) {
