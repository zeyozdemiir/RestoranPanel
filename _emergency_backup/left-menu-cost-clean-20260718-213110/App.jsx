...
import MenuCostPage from "./pages/MenuCost.jsx";

function isMenuCostPage(activePage) {
  const value = String(activePage || "").toLocaleLowerCase("tr-TR");
  return (
    value.includes("menü maliyet") ||
    value.includes("menu maliyet") ||
    value.includes("menü maliyeti") ||
    value.includes("menu cost")
  );
}
